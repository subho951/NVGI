...
<head>
  ...
  <title>NVGI - Manage Front Desk</title>
...
<div class="content">
  ...
  <div class="card shadow bg-light mb-4">
    <div class="card-body">
        <h6 class="text-center alert alert-info alert-sm py-2 px-2">Add Front Desk Manager</h6>
      	<form class="row g-3">
    ...
    <div class="col-md-3">
      <input class="form-control form-control-sm" placeholder="Write First Name" required>
    </div>
  ...
  <div class="card shadow bg-light">
    <div class="card-body">
         <h6 class="text-center alert alert-info alert-sm py-2 px-2">List of Front Desk Managers</h6>
        <table class="table table-bordered">
            ...
            <tr>
            	<td>NVGI/Jayeeta/9830098300</td>
                <td>Jayeeta Misra Roy</td>
                <td><a href="#" class="text-success">Active</a> <!--<a href="#" class="text-danger">Blocked</a>--> | <a href="#" class="text-danger">Delete</a></td>
            </tr>
            
            <tr>
            	<td>NVGI/Swastika/8989457812</td>
                <td>Swastika Dutta Achariya</td>
                <td><a href="#" class="text-success">Active</a> <!--<a href="#" class="text-danger">Blocked</a>--> | <a href="#" class="text-danger">Delete</a></td>
            </tr>
