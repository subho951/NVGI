...
<div class="content">
  ...
  <div class="card shadow bg-light mb-4">
    <div class="card-body">
        <h6 class="text-center alert alert-info alert-sm py-2 px-2">Add Unit</h6>
      	<form class="row g-3">
    ...
    <div class="col-md-3">
      <input class="form-control form-control-sm" placeholder="Write Unit Name (eg. VHS)" required>
    </div>
  ...
  <div class="card shadow bg-light">
    <div class="card-body">
         <h6 class="text-center alert alert-info alert-sm py-2 px-2">List of Units</h6>
