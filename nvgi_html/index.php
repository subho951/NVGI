...
<body>
  ...
  <div class="login-box">
    <h4 class="text-success text-center"><img src="image/TM-logo-new-vedant.png" class="w-75"><br>Student Management</h4>
    <form action="login-student-management.php">
    ...
    <h4 class="text-primary text-center"><img src="image/TM-logo-new-vedant.png" class="w-75"><br>Employee Management</h4>
    <form action="#">
