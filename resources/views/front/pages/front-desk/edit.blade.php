        ...
        <form method="POST" action="" class="row g-3">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm" name="middle_name" id="middle_name" placeholder="Write Middle Name" autocomplete="off" value="<?= (($single_row)?$single_row->middle_name:'') ?>">
