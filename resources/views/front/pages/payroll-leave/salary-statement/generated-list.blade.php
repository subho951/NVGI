...
<div class="salary-statement-space">
    <div class="salary-statement-header">
        <div class="d-flex flex-wrap justify-content-between align-items-start gap-2">
            <div>
                <h2 class="salary-statement-title">Generated Salary Statement</h2>
                <p class="salary-statement-subtitle">Month, branch and category wise generated salary statement batches with Excel, PDF and employee pay slips.</p>
            </div>
            <a href="{{ url($controllerRoute . '/list') }}" class="btn salary-statement-link-btn">
                <i class="fa-solid fa-magnifying-glass me-1"></i> Salary Statement Search
            </a>
        </div>
    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="salary-statement-action-group">
                                        <a class="btn btn-sm salary-statement-btn" href="{{ url($controllerRoute . '/download-excel') }}?{{ http_build_query($query) }}">
                                            <i class="fa-solid fa-file-excel me-1"></i> Excel
                                        </a>
                                        <a class="btn btn-sm salary-statement-btn" href="{{ url($controllerRoute . '/download-pdf') }}?{{ http_build_query($query) }}">
                                            <i class="fa-solid fa-file-pdf me-1"></i> PDF
                                        </a>
                                        <a class="btn btn-sm salary-statement-link-btn" href="{{ url($controllerRoute . '/employees') }}?{{ http_build_query($query) }}">
                                            <i class="fa-solid fa-users me-1"></i> Pay Slips
                                        </a>
                                    </div>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="8" class="text-center text-muted py-4">
                                    No generated salary statement found.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
