        ...
        <tr>
            <td align="center">
                <table role="presentation" width="680" cellpadding="0" cellspacing="0" style="max-width:680px; width:100%; background:#ffffff; border-radius:18px; overflow:hidden; border:1px solid #dce7ef; box-shadow:0 18px 45px rgba(23,49,69,.12);">
                    <tr>
                        <td style="background:#5f1d29; padding:28px 34px;">
                            ...
                            <h1 style="margin:8px 0 0; color:#ffffff; font-size:28px; line-height:1.2;">Application Rejected</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:30px 34px;">
                            <p style="margin:0 0 14px; font-size:16px; line-height:1.65;">Dear {{ $application->employee_name ?: 'Employee' }},</p>
                            <p style="margin:0 0 22px; color:#526a7f; font-size:15px; line-height:1.7;">Your CL leave application has been reviewed and rejected. The reason shared by the admin is included below.</p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #dce7ef; border-radius:14px; overflow:hidden;">
                                ...
                                <tr>
                                    <td style="padding:14px 16px; background:#f7fafc; color:#63798d; font-size:12px; font-weight:700; text-transform:uppercase;">Rejected Date</td>
                                    <td style="padding:14px 16px; background:#f7fafc; font-size:14px;">{{ $formatDate($application->rejected_at) }}</td>
                                </tr>
                                <tr>
                                    <td style="padding:14px 16px; color:#63798d; font-size:12px; font-weight:700; text-transform:uppercase;">Status</td>
                                    <td style="padding:14px 16px; font-size:14px;"><span style="display:inline-block; padding:7px 12px; border-radius:999px; background:#fde5e8; color:#b02a37; font-weight:700;">Rejected</span></td>
                                </tr>
                                <tr>
                                    <td style="padding:14px 16px; background:#f7fafc; color:#63798d; font-size:12px; font-weight:700; text-transform:uppercase;">Reject Reason</td>
                                    <td style="padding:14px 16px; background:#f7fafc; font-size:14px;">{{ $application->reject_reason ?: '--' }}</td>
                                </tr>
                            </table>

                            <p style="margin:24px 0 0; color:#526a7f; font-size:14px; line-height:1.7;">Please contact the administration team if you need further clarification.</p>
                        </td>
                    </tr>
                    <tr>
