        ...
        <tr>
            <td align="center">
                <table role="presentation" width="680" cellpadding="0" cellspacing="0" style="max-width:680px; width:100%; background:#ffffff; border-radius:18px; overflow:hidden; border:1px solid #dce7ef; box-shadow:0 18px 45px rgba(23,49,69,.12);">
                    <tr>
                        <td style="background:#123f35; padding:28px 34px;">
                            ...
                            <h1 style="margin:8px 0 0; color:#ffffff; font-size:28px; line-height:1.2;">Application Approved</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:30px 34px;">
                            <p style="margin:0 0 14px; font-size:16px; line-height:1.65;">Dear {{ $application->employee_name ?: 'Employee' }},</p>
                            <p style="margin:0 0 22px; color:#526a7f; font-size:15px; line-height:1.7;">Your CL leave application has been approved. The approved leave has been deducted from your available CL balance.</p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #dce7ef; border-radius:14px; overflow:hidden;">
                                ...
                                <tr>
                                    <td style="padding:14px 16px; background:#f7fafc; color:#63798d; font-size:12px; font-weight:700; text-transform:uppercase;">Approved Date</td>
                                    <td style="padding:14px 16px; background:#f7fafc; font-size:14px;">{{ $formatDate($application->approved_at) }}</td>
                                </tr>
                                <tr>
                                    <td style="padding:14px 16px; color:#63798d; font-size:12px; font-weight:700; text-transform:uppercase;">Status</td>
                                    <td style="padding:14px 16px; font-size:14px;"><span style="display:inline-block; padding:7px 12px; border-radius:999px; background:#dff5e7; color:#146c43; font-weight:700;">Approved</span></td>
                                </tr>
                                <tr>
                            ...
                            <p style="margin:24px 0 0; color:#526a7f; font-size:14px; line-height:1.7;">Please keep this email for your leave records.</p>
                        </td>
                    </tr>
                    <tr>
