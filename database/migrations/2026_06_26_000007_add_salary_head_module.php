...
{
    private const MODULE_ID = 36;
    private const MODULE_NAME = 'Payroll & Leave - Salary Head';
    private const PAYROLL_SETUP_MODULE_IDS = ['32', '33', '34'];
    ...
    public function up(): void
    {
        ...
        if (Schema::hasTable('roles')) {
            $this->grantSalaryHeadToPayrollSetupRoles($now);
        }
    }
    ...
    private function grantSalaryHeadToPayrollSetupRoles($now): void
    {
        ...
        foreach ($roles as $role) {
            ...
            if (count(array_intersect(self::PAYROLL_SETUP_MODULE_IDS, $moduleIds)) === 0) {
                continue;
            }
