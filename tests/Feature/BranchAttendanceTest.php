...
class BranchAttendanceTest extends TestCase
{
    ...
    private function seedAttendanceScenario(): void
    {
        ...
        $rosters = [
            ['id' => 100, 'branch_id' => 1, 'branch_name' => 'Bibirhat', 'in_time' => '08:00', 'out_time' => '10:00'],
            ['id' => 101, 'branch_id' => 2, 'branch_name' => 'Mukundapur', 'in_time' => '14:00', 'out_time' => '16:00'],
            ['id' => 102, 'branch_id' => 3, 'branch_name' => 'Rajarhat', 'in_time' => '18:00', 'out_time' => '20:00'],
        ];

        foreach ($rosters as $roster) {
            DB::table('employee_schedule_rosters')->insert(array_merge($roster, [
                'employee_id' => 10,
                'employee_no' => 'NVGI-0010',
                'employee_name' => 'Test TSA Teacher',
