...
use App\Http\Controllers\EmployeeAttendanceReportController;
...
/* Branch Employee Portal */
    ...
    Route::middleware(['branch.portal'])->prefix('branch-portal')->name('branch.portal.')->group(function () {
        ...
        Route::get('attendance-report', [EmployeeAttendanceReportController::class, 'branch'])->name('attendance.report');
    ...
    // Route::prefix('/admin')->namespace('App\Http\Controllers\Admin')->group(function(){
        ...
        Route::middleware(['auth'])->group(function () {
            ...
            /* employee */
                ...
                Route::post('employee/schedule-roster/vhs/copy', [EmployeeScheduleRosterController::class, 'vhsCopy'])->name('employee.schedule-roster.vhs.copy');
                ...
                Route::post('employee/schedule-roster/vhs/delete-date', [EmployeeScheduleRosterController::class, 'vhsDeleteDate'])->name('employee.schedule-roster.vhs.delete-date');
                ...
                Route::post('employee/schedule-roster/vhs/mark-attendance', [EmployeeScheduleRosterController::class, 'vhsMarkAttendance'])->name('employee.schedule-roster.vhs.mark-attendance');
                ...
                Route::post('employee/schedule-roster/front-desk-group-d/update-time', [EmployeeScheduleRosterController::class, 'supportUpdateTime'])->name('employee.schedule-roster.support.update-time');
                Route::post('employee/schedule-roster/front-desk-group-d/mark-attendance', [EmployeeScheduleRosterController::class, 'supportMarkAttendance'])->name('employee.schedule-roster.support.mark-attendance');
                ...
                Route::post('employee/schedule-roster/tsa/mark-attendance', [EmployeeScheduleRosterController::class, 'tsaMarkAttendance'])->name('employee.schedule-roster.tsa.mark-attendance');
